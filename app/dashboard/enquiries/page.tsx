    ...
    return (
      <div className="min-h-screen bg-[#f7f7f7] px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-3xl border border-border bg-white p-6 text-center text-sm text-text-secondary">
            Loading enquiries…
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#f7f7f7] px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 flex items-center justify-between gap-3">
          ...
          <button
            onClick={() => router.back()}
            className="rounded-full border border-border bg-white px-4 py-2 text-sm font-medium text-text hover:border-brand-300"
          >
            Back
          </button>
        </div>
        ...
        <div className="mb-6 rounded-3xl border border-border bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="rounded-full bg-brand-50 px-3 py-2 text-sm font-semibold text-brand-600">
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {!enquiry.is_read && (
                    <button
                      ...
                      className="rounded-full border border-brand-200 bg-white px-3 py-1.5 text-sm font-medium text-brand-600 hover:border-brand-300 disabled:opacity-60"
                    >
                ...
                <div className="mt-4 space-y-3 text-sm text-text-secondary">
                  <div className="flex flex-wrap gap-3">
                    <a href={`tel:${enquiry.phone}`} className="font-medium text-brand-600 hover:text-brand-700">
                      {enquiry.phone}
                    </a>
                    {enquiry.email && (
                      <a href={`mailto:${enquiry.email}`} className="font-medium text-brand-600 hover:text-brand-700">
                        {enquiry.email}
                      </a>
                    )}
                  </div>
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-text-secondary">Job</p>
                    <p className="mt-1 leading-6 text-text">{enquiry.description}</p>
                  </div>

                  <div className="flex flex-wrap items-center gap-3">
                    <span className="rounded-full bg-[#f1f5f9] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-text-secondary">
